export const projects = [
    {
        ...
        details: {
            ...
            desktopScreenshots: [
                ...
                "/images/Suryas Solar Web Desktop View 2.png",
                "/images/Suryas Solar Web Desktop View 3.png",
                "/images/Suryas Solar Web Desktop View 4.png",
                "/images/Suryas Solar Web Desktop View 5.png",
                "/images/Suryas Solar Web Desktop View 6.png",
                "/images/Suryas Solar Web Desktop View 7.png",
                "/images/Suryas Solar Web Desktop View 8.png"
            ],
            mobileScreenshots: [
                "/images/Suryas Solar Web Mobile View 1.png",
                "/images/Suryas Solar Web Mobile View 2.png",
                "/images/Suryas Solar Web Mobile View 3.png",
                "/images/Suryas Solar Web Mobile View 4.png",
                "/images/Suryas Solar Web Mobile View 5.png"
            ]
        }
    },
    {
        id: "gokul-oils",
        title: "Gokul Oils",
        subtitle: "Headless E-commerce Application",
        role: "Full Stack Developer / Lead Developer",
        description: "A premium, high-performance headless e-commerce platform built for a traditional wood-pressed oil brand. The project bridges the gap between traditional values and modern digital commerce, offering a lightning-fast, user-friendly shopping experience.",
        tags: ["Next.js 16", "TypeScript", "WooCommerce", "Tailwind CSS", "Framer Motion"],
        link: "https://gokuloils.in",
        ...
        details: {
            challenge: "The brand needed to stand out in a crowded market with a premium look that communicated purity and tradition. They required a robust platform to handle complex product variations and provide a seamless checkout experience.",
            solution: "Engineered a decoupled architecture using Next.js 16 for the frontend and WooCommerce as a headless CMS. Implemented On-Demand ISR for instant page loads, a custom single-page checkout with Razorpay, and gamified cart features to boost AOV.",
            impact: "Achieved high Core Web Vitals with sub-second page loads. The new platform supports dynamic order calculations, smart address management, and led to increased user engagement through diverse micro-interactions.",
            features: [
                { title: "Headless Architecture", desc: "Next.js frontend with WooCommerce CMS and On-Demand ISR." },
                { title: "Custom Checkout", desc: "Single-page flow with Razorpay, UPI support, and smart address auto-fill." },
                { title: "Gamified Cart", desc: "Slide-out drawer with progressive free shipping rewards and upsells." },
                { title: "Advanced Product Mgmt", desc: "Intelligent variation prioritizing and farm-to-bottle process timelines." },
                { title: "Order Tracking", desc: "Real-time status updates via dedicated tracking page." },
                { title: "Modern UI/UX", desc: "Premium 'Dark Hacker' aesthetic with smooth Framer Motion animations." }
            ],
            desktopScreenshots: [
